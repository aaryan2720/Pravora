    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <Link href="/" className="flex items-center justify-center gap-2 mb-10 group">
          <img src="/favicon.svg" alt="Pravora" width="36" height="36" className="w-9 h-9 object-contain" />
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl flex flex-col">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="customer-email" className="text-sm font-medium text-slate-300">Email or Mobile Number</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="customer-password" className="text-sm font-medium text-slate-300">Password</label>
              <div className="relative">
